		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					this.props.isDraggable && this.props.multi ? _react2.default.createElement(_Sortable2.default, {
						valueArray: valueArray,
...
Select.propTypes = {
	...
	disableOnClose: _propTypes2.default.bool, // Disable items on closed select
	...
	helperClass: _propTypes2.default.string, // class for draggable tags
	...
	isDeleteRight: _propTypes2.default.bool, // is Delete icon on right
	isDraggable: _propTypes2.default.bool, // whether the Multiselect has draggable tags
	...
	minSelected: _propTypes2.default.number, // minimum selected amount for draggable multiselect
